...
mod tests {
    ...
    #[test]
    fn test_equals_num(){
        run_comparison_test(&Token::new(TokenType::Equals, "==".to_string(), None, 0),
        vec![false, true, false]);
    }

    #[test]
    fn test_not_equals_num(){
        run_comparison_test(&Token::new(TokenType::BangEqual, "!=".to_string(), None, 0),
        vec![true, false, true]);
    }
    ...
    fn run_comparison_test(tok: &Token, cmps: Vec<bool>) {
        ...
        for (nums, c) in nums.iter().zip(cmps) {
            ...
            let result = terp.evaluate(&binary_expr);
            assert!(result.is_ok());
            assert_eq!(result.ok(), Some(Object::Bool(c)), "Testing {} {} 15.0", *nums, tok.as_string());
        }
    ...
    #[test]
    fn test_less_than(){
        run_comparison_test(&Token::new(TokenType::Less, "<".to_string(), None, 0),
        vec![true, false, false]);
    }

    #[test]
    fn test_less_than_or_equal_to(){
        run_comparison_test(&Token::new(TokenType::LessEqual, "<=".to_string(), None, 0),
        vec![true, true, false]);
    }

    #[test]
    fn test_greater_than(){
        run_comparison_test(&Token::new(TokenType::Greater, ">".to_string(), None, 0),
        vec![false, false, true]);
    }

    #[test]
    fn test_greater_than_equal_to(){
        run_comparison_test(&Token::new(TokenType::GreaterEqual, ">=".to_string(), None, 0),
        vec![false, true, true]);
    }
